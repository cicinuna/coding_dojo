class BankAccount
    ...
    def show_saving_balance
        puts "You have $#{@saving_balance} dollars in your savings account: #{@saving}."
        self
    end

    def show_checking_balance
        puts "You have $#{@checking_balance} dollars in your savings account: #{@checking}."
        self
    end
    ...
    def withdraw_from_checking(subtract)
        if @checking_balance < subtract
            puts "You don't have enough money in the checking account!"
            self
        else
